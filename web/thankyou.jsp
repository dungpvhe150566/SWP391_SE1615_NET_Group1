...
<html lang="en">
    ...
    <body>
        ...
        <h2 style="text-align: center">The seems products , you are added</h2>
        ...
        <div class="card-footer border-secondary bg-transparent">
            <button href ="ShopController" type="button" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Back To Shopping</button>
        </div>
    </div>
</div>
<!-- Shop Product End -->
