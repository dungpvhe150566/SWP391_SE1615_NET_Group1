                                ...
                                <tbody class="align-middle">
                                    ...
                                    <form action="update-quantity">
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <input  min='0' max="30" type="number" onkeypress="if(this.value.length==2)return false; return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" name ="quantity" onchange="this.form.submit()"  class="form-control form-control-sm bg-secondary text-center" value="${C.value.getAmount()}">
